    ...
    <div className="flex w-full flex-col md:flex-row-reverse flex-shrink-0">
      ...
      <div className=" flex flex-col justify-center items-center w-full md:w-[40%] px-6 lg:px-8 flex-shrink-0">
        <div className="w-full xl:w-[50%] flex flex-col items-center">
          ...
          />
          <div className="text-[#212B36] font-semibold text-3xl mb-3">
            Quên mật khẩu
          </div>
          ...
          <Form {...form}>
            <form
              ...
              className="w-full max-w-[320px] mt-[40px] space-y-4"
            >
              {/* Display API Error */}
              {error && (
              ...
              <Button
                type="submit"
                disabled={isPending}
                className="font-semibold text-white bg-primary-main hover:bg-primary-secondary disabled:bg-gray-400 disabled:cursor-not-allowed rounded-xl mt-4 w-full h-12"
              >
                {isPending ? (
                  <>
          ...
          <button
            ...
            className="mt-4 text-sm hover:text-primary-secondary cursor-pointer flex items-center gap-1"
            disabled={isPending}
          >
            ← Quay lại đăng nhập
          </button>
