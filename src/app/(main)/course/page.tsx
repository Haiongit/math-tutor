      ...
      <div className="bg-[linear-gradient(92.2deg,rgba(47,87,239,0.2)_0%,rgba(255,177,69,0.2)_100.43%)] h-[300px] w-full">
        <div className="flex flex-col items-center justify-center h-full">
          <div className="flex flex-col md:flex-row items-center md:gap-8">
            ...
            <div className="mt-2 md:mt-0 font-light text-[#9364E7] border bg-[#D14EA81F] border-white px-4 py-2 rounded-full">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mt-2 w-full">
            ...
            <div className="relative w-full sm:max-w-[320px]">
              <input
                ...
                className="pl-10 pr-10 py-2.5 w-full rounded-lg border border-gray-200 focus:outline-none focus:ring-1 focus:ring-[#9364E7] focus:border-[#9364E7]"
              />
              <Search
