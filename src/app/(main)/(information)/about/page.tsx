      ...
      <div className="md:max-w-3xl max-w-sm lg:max-w-5xl xl:max-w-7xl mx-auto w-full flex flex-col gap-[120px]">
        <div id="section-2" className="flex gap-16">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            <div className="bg-gradient-to-r from-[#9364E7] to-[#FFB145] bg-clip-text text-transparent w-fit text-lg font-semibold">
              Hiểu về chúng tôi
            </div>
            <div className="text-2xl leading-9 lg:text-3xl lg:leading-12 font-bold pb-2">
              Tìm hiểu về nền tảng học tập MathTutor
            </div>
            <div className="text-secondary">
              MathTutor là nền tảng học tập trực tuyến hiện đại, mang đến
              trải nghiệm giáo dục linh hoạt và hiệu quả cho học sinh ở mọi lứa
              tuổi. Với triết lý &#34;học mọi lúc, mọi nơi&#34;, MathTutor nổi bật
        ...
        <div id="selection-3" className="flex gap-8 lg:gap-16 lg:flex-row flex-col">
          <div className="lg:w-1/2 flex flex-col justify-center">
            ...
            <div className="text-secondary">
              Tại MathTutor, chúng tôi kết hợp công nghệ hiện đại, phương
          ...
          <div className="w-full lg:w-1/2 rounded-2xl overflow-hidden">
            <img
              ...
              alt="Hero Image"
              className="w-full lg:h-auto h-[426px] object-cover"
            />
          </div>
        </div>
